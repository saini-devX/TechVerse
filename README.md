...
![Clerk](https://img.shields.io/badge/Auth-Clerk-5B3DF5?logo=clerk&logoColor=white)
![Tailwind](https://img.shields.io/badge/TailwindCSS-38BDF8?logo=tailwindcss&logoColor=white)
![Vite](https://img.shields.io/badge/Vite-646CFF?logo=vite&logoColor=white)

## Overview
TechVerse is a modern MERN-stack eCommerce platform featuring secure authentication, intuitive product browsing, cart management, and Stripe-powered checkout. It is built with a scalable backend, clean REST APIs, and a responsive UI for a smooth online-shopping experience.
...
## Tech Stack
**Frontend:** React, Vite, TailwindCSS, Clerk, Stripe.js  
**Backend:** Node.js, Express.js, MongoDB, Stripe SDK  

## Environment Variables
The project uses standard environment variables:
